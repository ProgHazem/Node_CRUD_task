...
const inputFile = path.resolve(__dirname, "./csv/order_log00.csv");
const csvWriter = createCsvWriter({
    path: path.resolve(__dirname, "./csv/0_order_log00.csv"),
    header: [
        {id: 'name', title: 'name'},
...
const csvWriter2 = createCsvWriter({
    path: path.resolve(__dirname, "./csv/1_order_log00.csv"),
    header: [
        {id: 'name', title: 'name'},
